...
import picture1 from "./assets/48.jpeg";
import picture2 from "./assets/profile picture.jpeg";
...
function FriendsList({ friend, onSlection, selectedFriend }) {
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <label> 😒Who is paying thre bill?</label>
      <select
        value={whoIsPaying}
